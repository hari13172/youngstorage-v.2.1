...
export default function Navhovar() {
  ...
  const ChangePath = (pathname) => {
    console.log(pathname.trim().split("/").splice(1));
    setPath(pathname.split("/").splice(1));
              ...
              className={`cont ${
                path.length > 1
                  ? path[1] == String(a.pathname).toLocaleLowerCase() &&
                    "active"
                  : path[0] == String(a.pathname).toLocaleLowerCase() &&
                    "active"
              }`}
              key={a.pathname}
              onClick={() =>
                ChangePath(`
                  /dashboard${
                    String(a.pathname).toLocaleLowerCase() == "dashboard"
                      ? ""
        ...
        <div className="main-menu">
          {paths.subpath.map((a) => (
            <div
              ...
              onClick={() =>
                ChangePath(`
                  /dashboard/${String(a.pathname).toLocaleLowerCase()}`)
              }
            >
  ...
  mainpath: [
    {
      ...
      svg: (
        ...
        >
          <path
            strokeWidth={2}
            d="M15.5452 5.73877C16.8712 5.73877 18.143 6.26555 19.0807 7.20324C20.0184 8.14092 20.5452 9.41269 20.5452 10.7388C20.5452 12.0649 20.0184 13.3366 19.0807 14.2743C18.143 15.212 16.8712 15.7388 15.5452 15.7388C14.2191 15.7388 12.9473 15.212 12.0096 14.2743C11.072 13.3366 10.5452 12.0649 10.5452 10.7388C10.5452 9.41269 11.072 8.14092 12.0096 7.20324C12.9473 6.26555 14.2191 5.73877 15.5452 5.73877ZM15.5452 18.2388C21.0702 18.2388 25.5452 20.4763 25.5452 23.2388V25.7388H5.54517V23.2388C5.54517 20.4763 10.0202 18.2388 15.5452 18.2388Z"
          />
        </svg>
      ),
    },
