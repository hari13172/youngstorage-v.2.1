...
import "@/app/auth/signup/signup.scss";
...
function signup() {
  ...
  const onSubmit = async (data) => {
    ...
    if (data.password == data.confirmpassword) {
      const signupData = await API.signup(data);
      ...
      alert("please check the password and confirm password doesn't match");
    }
  };
            ...
            <div className="right-comp">
              ...
              <div className="icons">
                <Controller
                  ...
                  defaultValue=""
                  render={({ field }) => (
                    <input {...field} type="number" placeholder="phoneNumber" />
                  )}
                  rules={{
